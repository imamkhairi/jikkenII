...
rironchi = [(lambda x: 945/3840)(x) for x in range(len(x))] 
...
gosa = [(lambda x: abs((945/3840) - x))(x) for x in percentage]
...
ax1.set_xlabel("N value", fontsize=16)
#ax2.invert_yaxis()
